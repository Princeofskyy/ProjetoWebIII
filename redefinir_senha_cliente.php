...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($cliente->redefinirSenha($codigo, $nova_senha)) {
...
<head>
    ...
    <link rel="stylesheet" href="./css/redefinir_cliente.css">
</head>
...
<div class="redefinir-container">
    ...
    <input type="button" value="Voltar" onclick="window.location.href='login.php';" class="button">
</div>
</body>
